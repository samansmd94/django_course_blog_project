...
class BlogPostTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post1 = Post.objects.create(
            title='Post1',
            text="This is the description of the post1",
            status=Post.STATUS_CHOICES[0][0],  # published
            author=cls.user,
        )
        cls.post2 = Post.objects.create(
            title='Post2',
            text="This is the description of the post2",
    ...
    def test_post_detail(self):
        ...
        self.assertEqual(self.post1.text, 'This is the description of the post1')
    ...
    def test_template_name_is_valid(self):
        response = self.client.get("/blog/")
